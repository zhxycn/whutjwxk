...
export const login = (loginname: string, password: string, captcha: string, uuid: string) =>
  invoke("login", { loginname, password, captcha, uuid });

export const checkSession = () => invoke("check_session", {});

export const getCourseList = (batchCode: string, classType: string, page: number) =>
  invoke("get_course_list", { batchCode, classType, page });

export const grabCourse = (clazzId: string, secretVal: string, batchId: string, clazzType: string) =>
...
export const dropCourse = (clazzId: string, secretVal: string, batchId: string) =>
